...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 flex items-center justify-center  transition-colors duration-500 overflow-hidden relative font-sans">

            <div className="w-full max-w-xl relative z-10">
                <div
                    data-aos="zoom-in"
                    className="bg-white/70 dark:bg-slate-900/40 backdrop-blur-2xl rounded-[3rem] shadow-2xl shadow-rose-600/5 border border-slate-200 dark:border-white/5 p-8 md:p-8"
                >
                    <div className="text-center mb-10">
                        ...
                        <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white italic tracking-tighter mb-3 uppercase">
                            Join <span className="text-rose-600">Forces</span>
                        </h2>
                        <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">Create your hero profile and start saving lives.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 rounded-2xl focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 outline-none transition text-slate-800 dark:text-white font-medium"
                        ...
                        {/* Row: Blood Group & Photo */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Blood Group</label>
                                <div className="relative">
                                    <Droplet className="absolute left-5 top-1/2 -translate-y-1/2 w-5 h-5 text-rose-500/80 z-10" />
                                    <select
                                        {...register('blood_group', { required: 'Required' })}
                                        className="w-full pl-14 pr-6 py-4 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 rounded-2xl appearance-none outline-none focus:border-rose-500 text-slate-700 dark:text-slate-200 font-semibold cursor-pointer transition-all"
                                    >
                            ...
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-2">Profile Photo</label>
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-14 pr-4 py-3.5 bg-slate-50 dark:bg-slate-950/50 border border-dashed border-slate-300 dark:border-white/10 rounded-2xl file:hidden cursor-pointer text-slate-500 text-[11px] focus:border-rose-500 transition-all"
                                    />
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2">
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-12 py-4 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-white/5 rounded-2xl outline-none focus:border-rose-500 transition text-slate-800 dark:text-white"
                        ...
                        <button
                            type="submit"
                            className="w-full bg-rose-600 hover:bg-rose-700 text-white py-2 rounded-3xl font-black  tracking-[0.15em] text-lg shadow-2xl shadow-rose-600/20 active:scale-[0.97] transition-all duration-500 mt-4 uppercase"
                        >
                            Sign Up
                        </button>
                    </form>
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">
                            ...
                            <Link to="/login" className="text-rose-600 hover:underline font-black italic ml-1 uppercase">
                                Log In
                            </Link>
                        </p>
                    </div>
