...
import { MapPin, Phone, Search, Loader2, Droplets, UserCheck, Shield, Mail } from "lucide-react";
...
const AllDonors = () => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-600 animate-pulse font-mono">
          Syncing Database...
        </p>
      </div>
    );
  ...
  return (
    <div className={`${C.page} font-mono relative pb-20 transition-colors duration-200`}>
      ...
      <header className="flex flex-wrap items-end justify-between gap-6 mb-10 max-w-7xl mx-auto pt-6">
        ...
        <div className={`w-full lg:w-96 border rounded-xl px-5 py-3.5 flex items-center gap-3 focus-within:border-rose-500 transition-all duration-200
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-5 mb-8">
                  <div className="relative">
                    <div className="w-20 h-20 rounded-2xl flex items-center justify-center overflow-hidden border-2 transition-all"
                      ...
                      <img
                        src={donor.photoURL || `https://ui-avatars.com/api/?name=${donor.name}`}
                        alt=""
                        className="w-full h-full object-cover grayscale-30 group-hover:grayscale-0 transition-all duration-500"
                      />
                    </div>
                    <div className="absolute -bottom-2 -right-2 bg-rose-600 text-white text-[10px] font-black px-3 py-1 rounded-lg shadow-lg border-2"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-[0.2em]">Verified Hero</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className={`text-[8px] font-bold uppercase tracking-widest mb-0.5 ${C.label}`}>Location</p>
                      <p className="text-[11px] font-bold">{donor.upazila}, {donor.district}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className={`text-[8px] font-bold uppercase tracking-widest mb-0.5 ${C.label}`}>Contact</p>
                      <p className="text-[11px] font-bold">{donor.phone || "Restricted"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-2 border-t" style={{ borderColor: dark ? '#1c1c2e' : '#f1f5f9' }}>
                  <a
                    ...
                    className="flex-3 flex items-center justify-center py-3.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl font-black text-[10px] uppercase tracking-[0.2em] transition-all shadow-lg shadow-rose-600/20 active:scale-95"
                  >
                    Initiate Call
                  </a>
                  <button className={`flex-1 flex items-center justify-center rounded-xl border transition-all hover:text-rose-600
