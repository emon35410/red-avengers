...
const AllVolunteers = () => {
  ...
  return (
    <div
      className={`${C.page} font-mono relative py-5 transition-colors duration-200`}
    >
      {/* ── Header Section ── */}
      <header className="flex flex-wrap items-end justify-between gap-6 mb-10 max-w-7xl mx-auto pt-6">
        ...
        {/* Search Bar */}
        <div
          className={`w-full lg:w-96 border rounded-xl px-5 py-3.5 flex items-center gap-3 focus-within:border-emerald-500 transition-all duration-200
          ...
          {filteredVolunteers.map((volunteer) => (
            ...
            >
              ...
              <div className="relative z-10">
                  ...
                  <div className="relative">
                    ...
                    >
                      <img
                        src={
                          volunteer.photoURL ||
                          `https://ui-avatars.com/api/?name=${volunteer.name}`
                        }
                        alt=""
                    ...
                    <div
                      className="absolute -bottom-2 -right-2 bg-emerald-500 text-white text-[10px] font-black p-1.5 rounded-lg shadow-lg border-2"
                ...
                >
                  <button className="flex-3 flex items-center justify-center py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-black text-[12px] uppercase tracking-[0.2em] transition-all shadow-lg shadow-emerald-600/20 active:scale-95">
                    View Activities
                  </button>
                </div>
              </div>
